...
public class TestDataImporter {
    ...
    static Company saveCompany(Session session, String name) {
    ...
    static User saveUser(Session session,
                          String firstName,
                          String lastName,
                          LocalDate birth_day,
                          Company company) {
    ...
    static void savePayment(Session session, User user, Integer amount) {
